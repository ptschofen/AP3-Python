...
path='C:/Users/ptsch/Box/AP3_Python_OpenSource/Model_Components'
...
def emissionVitalsEntry():
    ...
    areaSourceEmissions = np.load(path + '/Emissions/area_sources_' + year + '.npy')
    lowStackEmissions = np.load(path + '/Emissions/low_' + year + '.npy')
    medStackEmissions = np.load(path + '/Emissions/medium_' + year + '.npy')
    tallStackEmissions = np.load(path + '/Emissions/tall_' + year + '.npy')
    tall2StackEmissions = np.load(path + '/Emissions/tall2_' + year + '.npy')
    '''
    ...
    population = np.load(path + '/Population_Mortality/pop_' + year + '.npy')
    mortality = np.load(path + '/Population_Mortality/mort_' + year + '.npy')
    '''
...
def sourceReceptorReadin():
    ...
    ## Area Sources
    areaSRNOx = np.load(path + '/SR_Matrices/areaSRNOx.npy')
    areaSRPMVOC = np.load(path + '/SR_Matrices/areaSRPMVOC.npy')
    areaSRSO2 = np.load(path + '/SR_Matrices/areaSRSO2.npy')
    areaSRNH3 = np.load(path + '/SR_Matrices/areaSRNH3.npy')
    '''
    ...
    ## Low
    lowSRNOx = np.load(path + '/SR_Matrices/lowSRNOx.npy')
    lowSRPMVOC = np.load(path + '/SR_Matrices/lowSRPMVOC.npy')
    lowSRSO2 = np.load(path + '/SR_Matrices/lowSRSO2.npy')
    lowSRNH3 = np.load(path + '/SR_Matrices/lowSRNH3.npy')
    '''
    ...
    ## Medium
    medSRNOx = np.load(path + '/SR_Matrices/medSRNOx.npy')
    medSRPMVOC = np.load(path + '/SR_Matrices/medSRPMVOC.npy')
    medSRSO2 = np.load(path + '/SR_Matrices/medSRSO2.npy')
    medSRNH3 = np.load(path + '/SR_Matrices/medSRNH3.npy')
    '''
    ...
    ## Tall
    tallSRNOx = np.load(path + '/SR_Matrices/tallSRNOx.npy')
    tallSRPMVOC = np.load(path + '/SR_Matrices/tallSRPMVOC.npy')
    tallSRSO2 = np.load(path + '/SR_Matrices/tallSRSO2.npy')
    tallSRNH3 = np.load(path + '/SR_Matrices/tallSRNH3.npy')
    '''
    ...
    ## Tall2
    tall2SRNOx = np.load(path + '/SR_Matrices/tall2SRNOx.npy')
    tall2SRPMVOC = np.load(path + '/SR_Matrices/tall2SRPMVOC.npy')
    tall2SRSO2 = np.load(path + '/SR_Matrices/tall2SRSO2.npy')
    tall2SRNH3 = np.load(path + '/SR_Matrices/tall2SRNH3.npy')
    '''
